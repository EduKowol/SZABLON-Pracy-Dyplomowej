...
]{chapters/16-zalacznik-i-kod/code/moving_average.py}
...
Konfigurację polecenia wczytującego wybrany zakres wierszy przedstawia
listing~\ref{lst:inputlisting-zakres}.
...
]{chapters/16-zalacznik-i-kod/code/moving_average.m}
...
]{chapters/16-zalacznik-i-kod/code/moving_average.cpp}
...
czy jest to wynik rzeczywistego uruchomienia, czy skrócony przykład. Tak sformatowany
wynik pokazano w listingu~\ref{lst:wynik-programu}.
