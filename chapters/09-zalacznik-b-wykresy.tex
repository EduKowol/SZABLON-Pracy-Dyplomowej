  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot[thesislinkblue,very thick,mark=*]
        ...
        {chapters/09-zalacznik-b-wykresy/data/odpowiedz.csv};
    ...
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot[only marks,mark=*,black,mark size=2.2pt]
          ...
          {chapters/09-zalacznik-b-wykresy/data/aproksymacja.csv};
    ...
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot[thesiscodestring,dashed,line width=1.2pt]
          ...
          {chapters/09-zalacznik-b-wykresy/data/interpolacja.csv};
...
]{chapters/09-zalacznik-b-wykresy/scripts/wykres.py}

\lstinputlisting[
  style=thesis-matlab,
  caption={\ploren{Aproksymacja i eksport wykresu w MATLAB-ie}{Approximation and plot export in MATLAB}}
]{chapters/09-zalacznik-b-wykresy/scripts/wykres.m}
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot[hist={bins=8},fill=thesislinkblue!55,draw=black]
        ...
        {chapters/09-zalacznik-b-wykresy/data/proby.csv};
    \end{axis}
  \end{tikzpicture}
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot[matrix plot*,point meta=explicit]
        ...
        {chapters/09-zalacznik-b-wykresy/data/mapa-cieplna.csv};
    \end{axis}
  \end{tikzpicture}
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot[matrix plot*,point meta=explicit]
        ...
        {chapters/09-zalacznik-b-wykresy/data/spektrogram.csv};
    \end{axis}
  \end{tikzpicture}
